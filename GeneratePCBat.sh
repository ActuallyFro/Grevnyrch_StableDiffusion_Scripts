...
clothing=(turban changshan hanfu Cheongsam Lederhosen Drindl sarafan Telnyashka Traje_de_flamenca Achkan Dhoti Sherwani Mekhela_chador Sari Top_hat Bowler_hat Sporran Smock-frock Forcado Tartan Papakha Hanbok Haute_couture Fengguan)
...
# for i in `seq 1 $TotalToGenerate`; do
  ...
  # 2 in 3 chance of random clothing
  if [ $((RANDOM % 3)) -ne 0 ]; then
    randMood="$randMood, wearing $randClothing,"
  fi
